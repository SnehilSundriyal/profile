...
const variantStyles = {
  primary:
    'bg-[#16610E] font-semibold text-[#dfc28d] hover:bg-zinc-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-[#B6F500] dark:text-[#40210b] dark:hover:bg-zinc-600 dark:active:bg-zinc-700 dark:active:text-zinc-100/70',
  secondary:
