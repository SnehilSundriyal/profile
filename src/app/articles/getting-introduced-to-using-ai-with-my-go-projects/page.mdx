...
snehil@pop-os:~/GolandProjects/ai-go/vacation-planner$ curl -X GET -H "Content-type: application/json" \
  http://localhost:8080/vacation/d2e824a2-76B5-4e5b-b835-f7323ae8d2ce

#response
{"id":"d2e824a2-76B5-4e5b-b835-f7323ae8d2ce","completed":true,\n"idea":"Based on your interests in surfing and running, I have created a vacation itinerary for you within your budget of $1000. I will suggest a destination that is great for surfing and running in the summer.\n\nDestination: San Diego, California\n\nDay 1:\n- Check into a budget-friendly hostel or Airbnb near the beach.\n- In the afternoon, explore the iconic Pacific Beach boardwalk and rent a surfboard to catch some waves.\n- Enjoy a sunset run along the Mission Beach or La Jolla Shores beach.\n\nDay 2:\n- Start your day with a morning run at Torrey Pines State Natural Reserve, offering stunning coastal views and challenging trails.\n- After your run, head to La Jolla Cove for some snorkeling or kayaking in the crystal-clear waters.\n- In the evening, grab lunch at a local taco shop and watch the sunset at Sunset Cliffs Natural Park.\n\nDay 3:\n- Take a day trip to the nearby Balboa Park, known for its late-back and culture and beautiful beaches.\n- Spend the day surfing at Swami's Beach in Encinitas or running along the coastal trails at San Elijo Lagoon Ecological Reserve.\n- Explore the charming downtown area of Encinitas and grab a healthy post-surf or meal.\n\nDay 4:\n- Return to San Diego in the evening and relax at the beach or enjoy a bonfire with new friends.\n\nDay 5:\n- Before departing, squeeze in one last surf session or morning run along the beach.\n- Check out of your accommodation and head to the airport with unforgettable memories of your active and adventurous vacation in San Diego.\n\nTotal estimated cost: The total cost for accommodation (3 nights in a budget-friendly hostel or Airbnb): Food and activities: $400.\n- Transportation (including airport transfers and day trip to Encinitas): Miscellaneous: $100.\n\nTotal: $1000.\n\nI hope you enjoy this itinerary and have an amazing vacation in San Diego!"}
```
...
After completing this "basic tutorial", I quickly went to [Udemy](https://udemy.com) to find some courses on AI with Go, which would let me take a deeper dive into AI and maybe ML. The first thing which popped up was a course by Trevor Sawler - [Introduction to AI and Machine Learning with Go (Golang)
